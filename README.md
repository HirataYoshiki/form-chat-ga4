...
### ディレクトリ構成のポイント
- `frontend/src/components/`: 主要なページコンポーネント (e.g., `TenantListPage.tsx`, `LoginPage.tsx`, `ProtectedRoute.tsx`)
...
### 認証に関する注意点 (旧)
（このセクションは新しい認証機能の説明に置き換えられましたが、開発の経緯として残すことも可能です。今回は削除して新しい情報に統一します。）
